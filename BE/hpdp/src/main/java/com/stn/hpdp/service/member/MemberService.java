...
public class MemberService {
    ...
    public ApiResponse<Object> signIn(SignInReq signIpReq, HttpServletResponse response) {
        ...
        if (memberRepository.findByLoginId(signIpReq.getLoginId()).orElse(null) == null) {
            throw new CustomException(USER_BAD_REQUEST);
        }
        ...
        return ApiResponse.messageOk("로그인에 성공했습니다.");
    }
